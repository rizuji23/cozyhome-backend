...
class StokGudangSerializer(serializers.ModelSerializer):
    ...
    class Meta(object):
        model = Stok_Gudang
        fields = ('id_stok_gudang', 'id_material', 'id_material_2', 'nama_material', 'kategori_material', 'stok', 'last_stok', 'created_at', 'updated_at')
...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta(object):
        model = Project
        fields = ('id_project', 'nama_project', 'nama_customer', 'jumlah_volumn', 'estimasi_pengerjaan', 'kategori_project', 'total_cost', 'desc', 'status', 'created_at', 'updated_at')
